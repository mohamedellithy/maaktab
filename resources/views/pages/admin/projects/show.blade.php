        ...
        <!-- Basic Layout -->
            <div class="row">
                <div class="col-xl" style="padding: 0px 10px 10px;text-align: left;">
                    <a href="{{ route('admin.projects.edit',$project->id) }}" class="btn btn-success btn-sm">تعديل المنتج</a>
                </div>
                <br/>
            </div>
            <div class="row">
