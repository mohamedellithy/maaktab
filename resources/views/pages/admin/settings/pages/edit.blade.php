                ...
                <div class="col-lg-8">
                    ...
                    @if($page->slug == '/')
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <div class="mb-3">
                                    <label class="form-label" for="basic-default-company">مميزاتنا</label>
                                </div>
                                <div class="form-check form-switch mb-2">
                                ...
                                <div class="settings-page" style="cursor: pointer">
                                    ...
                                    <div class="collapse" id="collapseExample5">
                                        <div class="card card-body">
                                            ...
                                            <div class="mb-3">
                                                <label>نص وصفي</label>
                                                <textarea name="content[introduce_banner][description]" class="form-control">@isset($page->content['introduce_banner']['description']) {{ $page->content['introduce_banner']['description'] }} @endisset</textarea>
                                            </div>
                                            <div class="mb-3">
                                                <table class="table">
                                                    <thead>
                                                        <tr>
                                                            <th>المزايا التى نقدمها</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <div class="mb-3">
                                                                    ...
                                                                    <input name="content[introduce_banner][feature_title][0]" @isset($page->content['introduce_banner']['feature_title'][0]) value="{{ $page->content['introduce_banner']['feature_title'][0] }}" @endisset  class="form-control"/>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="mb-3">
                                                                    ...
                                                                    <textarea rows="3" name="content[introduce_banner][feature_description][0]" class="form-control">
                                                                        @isset($page->content['introduce_banner']['feature_description'][0])
                                                                            {{ $page->content['introduce_banner']['feature_description'][0] }}
                                                                        @endisset
                                                                    </textarea>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="mb-3">
                                                                    <label>وصف الميزة</label>
                                                                    <textarea rows="3" name="content[introduce_banner][feature_description][1]" class="form-control">
                                                                        @isset($page->content['introduce_banner']['feature_description'][1])
                                                                            {{ $page->content['introduce_banner']['feature_description'][1] }}
                                                                        @endisset
                                                                    </textarea>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="mb-3">
                                                                    <label>عنوان الميزة</label>
                                                                    <input name="content[introduce_banner][feature_title][2]" @isset($page->content['introduce_banner']['feature_title'][2]) value="{{ $page->content['introduce_banner']['feature_title'][2] }}" @endisset  class="form-control"/>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <div class="mb-3">
                                                                    ...
                                                                    <textarea rows="3" name="content[introduce_banner][feature_description][2]" class="form-control">
                                                                        @isset($page->content['introduce_banner']['feature_description'][2])
                                                                            {{ $page->content['introduce_banner']['feature_description'][2] }}
                                                                        @endisset
                                                                    </textarea>
                                                                </div>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <div class="mb-3">
                                                                    <label>وصف الميزة</label>
                                                                    <textarea rows="3" name="content[introduce_banner][feature_description][3]" class="form-control">
                                                                        @isset($page->content['introduce_banner']['feature_description'][3])
                                                                            {{ $page->content['introduce_banner']['feature_description'][3] }}
                                                                        @endisset
                                                                    </textarea>
                                                                </div>
                                                            </td>
                                    ...
                                    <div class="collapse" id="collapseExample66">
                                        <div class="card card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea name="content[contact_banner][location]" class="form-control">@isset($page->content['contact_banner']['location']) {{ $page->content['contact_banner']['location'] }} @endisset</textarea>
                                            </div>
                                            <div class="mb-3">
                                                <label>ايميلات الشركة</label>
                                                <textarea name="content[contact_banner][emails]" class="form-control">@isset($page->content['contact_banner']['emails']) {{ $page->content['contact_banner']['emails'] }} @endisset</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="settings-page" style="cursor: pointer">
                                    ...
                                    <div class="collapse" id="collapseExample77">
                                        <div class="card card-body">
                                            ...
                                            <div class="mb-3">
                                                <label>نص وصفي</label>
                                                <textarea name="content[our_reviews_banner][description]" class="form-control">@isset($page->content['our_reviews_banner']['description']) {{ $page->content['our_reviews_banner']['description'] }} @endisset</textarea>
                                            </div>
                                            <div class="mb-3">
                                                <table class="table">
                                                    <thead>
                                                            ...
                                                            <td>
                                                                <div class="container-uploader">
                                                                    <button type="button" class="btn btn-outline-warning btn-sm upload-media" data-type-media="image">
                                                                        <i class='bx bx-upload' ></i>
                                                                        اضافة صورة
                                                                       <input type="hidden" name="content[our_reviews_banner][thumbnail_id][0]" @isset($page->content['our_reviews_banner']['thumbnail_id'][0]) value="{{ $page->content['our_reviews_banner']['thumbnail_id'][0] }}" @endisset
                                                                            class="form-control dob-picker uploaded-media-ids" required/>
                                                                    </button>
                                                                    <div class="preview-thumbs">
                                                                        <br/>
                                                                        <ul class="list-preview-thumbs">
                                                                            @isset($page->content['our_reviews_banner']['thumbnail_id'][0])
                                                                                @include('partials.media_preview_list',['media_id' => $page->content['our_reviews_banner']['thumbnail_id'][0]])
                                                                            @endisset
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="container-uploader">
                                                                    <button type="button" class="btn btn-outline-warning btn-sm upload-media" data-type-media="image">
                                                                        <i class='bx bx-upload' ></i>
                                                                        اضافة صورة
                                                                       <input type="hidden" name="content[our_reviews_banner][thumbnail_id][1]" @isset($page->content['our_reviews_banner']['thumbnail_id'][1]) value="{{ $page->content['our_reviews_banner']['thumbnail_id'][1] }}" @endisset
                                                                            class="form-control dob-picker uploaded-media-ids" required/>
                                                                    </button>
                                                                    <div class="preview-thumbs">
                                                                        <br/>
                                                                        <ul class="list-preview-thumbs">
                                                                            @isset($page->content['our_reviews_banner']['thumbnail_id'][1])
                                                                                @include('partials.media_preview_list',['media_id' => $page->content['our_reviews_banner']['thumbnail_id'][1]])
                                                                            @endisset
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <td>
                                                                <div class="container-uploader">
                                                                    <button type="button" class="btn btn-outline-warning btn-sm upload-media" data-type-media="image">
                                                                        <i class='bx bx-upload' ></i>
                                                                        اضافة صورة
                                                                       <input type="hidden" name="content[our_reviews_banner][thumbnail_id][2]" @isset($page->content['our_reviews_banner']['thumbnail_id'][2]) value="{{ $page->content['our_reviews_banner']['thumbnail_id'][2] }}" @endisset
                                                                            class="form-control dob-picker uploaded-media-ids" required/>
                                                                    </button>
                                                                    <div class="preview-thumbs">
                                                                        <br/>
                                                                        <ul class="list-preview-thumbs">
                                                                            @isset($page->content['our_reviews_banner']['thumbnail_id'][2])
                                                                                @include('partials.media_preview_list',['media_id' => $page->content['our_reviews_banner']['thumbnail_id'][2]])
                                                                            @endisset
                                                                        </ul>
                                                                    </div>
                                                                </div>
