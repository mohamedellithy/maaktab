...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4" style="padding-bottom: 0rem !important;">انشاء نموذج طلب الخدمات</h4>
        <!-- Basic Layout -->
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text"  name="app_name" value="{{ old('app_name') }}" class="form-control" />
                            </div>
                            <div class="mb-3">
            ...
            load_child_categories:function(main_category){
                ...
                $.ajax({
                    ...
                    success: function( result ) {
                       ApllicationForm.CategoryOptions(result.item);
                    }
                });
            },
