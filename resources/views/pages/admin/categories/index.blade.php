...
@section('content')
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4">انشاء تصنيفات الخدمات</h4>
        <!-- Basic Layout -->
        <div class="row">
            <div class="col-xl">
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.categories.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <button type="submit" class="btn btn-primary btn-sm">انشاء التصنيف</button>
                        </form>
                    </div>
                </div>
            </div>
                            ...
                            <form method="get">
                                <div class="container-uploader private-filter d-flex">
                                    <div class="form-group">
                                        <input type="text" name="search" value="{{ $search }}" class="form-control" placeholder="البحث"/>
                                    </div>
                                    <div class="form-group">
